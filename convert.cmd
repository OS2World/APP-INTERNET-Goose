/*
 * Convert Goose Homepage List File Format 2.0 -> 2.1
 *
 */

say ""
say "Convert Goose Homepage List File Format 2.0 -> 2.1 "
say ""
...
say "  1.Backup Homepage.lst file as Homepage.old"
address cmd "@copy "data_file" homepage.old"
say ""
...
do until lines(data_file) = 0
    ...
    if left(line_text, 1) <> ";" then do
        ...
        url.i = ""
        last_data.i = ""
        parse var line_text '"'title.i '","' url.i '","' ldate.i '","' status.i'"'
    end
end
...
do i = 1 to url.0
    call lineout data_file, '"'title.i'","'url.i'","'ldate.i'"," ","'status.i'"'
end
call lineout data_file
